...
- **업스트림 제보 완료(2026-09-09): ROCm/TheRock Issue #8095** — 동일 GPU Windows/Linux A/B(val_bpb 1.9285 vs 1.6439) + 7.13 나이틀리 재현(1.9582) 첨부. https://github.com/ROCm/TheRock/issues/8095
